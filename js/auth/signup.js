...
function InscrireUtilisateur() {
    ...
    let raw = JSON.stringify({
        firstName: document.getElementById("NomInput").value.trim(),
        lastName: document.getElementById("PrenomInput").value.trim(),
    ...
    fetch(apiUrl + "registration", requestOptions)
        ...
        .then(result => {
            ...
            document.getElementById("signupSuccessMessage").innerHTML =
                prenom +
                ", votre compte a été créé avec succès.<br><br>Vous pouvez maintenant vous connecter.";

            const modal = new bootstrap.Modal(
                document.getElementById("successSignupModal")
            );

            modal.show();

            document
                .getElementById("signupSuccessButton")
